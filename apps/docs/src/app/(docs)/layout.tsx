    ...
    <ToastProvider position="bottom-right">
      <CommandPaletteProvider>
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
          {/* Header */}
          <Header sticky bordered className="h-14 justify-between px-4 lg:px-6 bg-[var(--background)]/95 backdrop-blur-lg">
            <div className="flex items-center gap-3">
              ...
              {/* Logo */}
              <Link href="/docs" className="text-sm font-semibold text-[var(--primary)] no-underline flex items-center gap-2 hover:opacity-80 transition-opacity">
