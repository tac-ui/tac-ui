        ...
        <>
          <SidebarContent>
            <div className="flex flex-col gap-1">
              ...
              {['Introduction', 'Installation', 'Quick Start', 'Configuration', 'API Reference', 'Examples'].map(
                (item, i) => (
                  <div
                    key={item}
    ...
    >
      <article className="flex flex-col gap-6 max-w-none">
        <div>
          ...
          <p className="text-[var(--muted-foreground)] m-0 mt-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm leading-relaxed m-0">
            This framework provides a comprehensive set of tools for building modern web applications. It includes a
            component library, state management utilities, and an extensive plugin system.
          </p>
          ...
          <p className="text-sm leading-relaxed m-0">
            After installation, import the provider and wrap your application root. This enables all framework features
            including theming, state management, and component rendering.
          </p>
