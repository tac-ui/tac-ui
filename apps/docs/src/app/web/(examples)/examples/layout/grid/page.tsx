    ...
    >
      {items.map((item) => {
        ...
        return (
          <div
            key={item.title}
            className="p-6 rounded-[var(--radius-lg)] border border-solid border-[var(--border)] bg-[var(--card)] hover:border-[var(--primary)]/40 transition-colors cursor-pointer flex flex-col gap-4"
          >
            <div
              className="w-12 h-12 rounded-[var(--radius-m)] flex items-center justify-center"
