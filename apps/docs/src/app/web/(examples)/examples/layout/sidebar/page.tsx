    ...
    <SidebarPage
      ...
      sidebar={
        <SidebarGroup label="Navigation">
          <SidebarItem variant="filled" size="md" icon={<Home size={16} />}>
            Home
          </SidebarItem>
          <SidebarItem variant="filled" size="md" icon={<Inbox size={16} />} active>
            Inbox
          </SidebarItem>
          <SidebarItem variant="filled" size="md" icon={<FileText size={16} />}>
            Documents
          </SidebarItem>
          <SidebarItem variant="filled" size="md" icon={<Users size={16} />}>
            Team
          </SidebarItem>
          <SidebarItem variant="filled" size="md" icon={<BarChart3 size={16} />}>
            Analytics
          </SidebarItem>
          <SidebarItem variant="filled" size="md" icon={<Settings size={16} />}>
            Settings
          </SidebarItem>
        </SidebarGroup>
      }
    >
      <div className="flex flex-col gap-6">
        ...
        {['Design review feedback', 'Sprint planning notes', 'API documentation update'].map((title, i) => (
          <div
            key={i}
            className="p-4 rounded-[var(--radius-m)] border border-solid border-[var(--border)] bg-[var(--card)] flex flex-col gap-2 hover:border-[var(--primary)]/40 transition-colors cursor-pointer"
          >
