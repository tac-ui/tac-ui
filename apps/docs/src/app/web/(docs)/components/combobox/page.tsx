...
function ControlledExample() {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <Combobox options={frameworkOptions} value={value} onChange={setValue} placeholder="Select a framework..." />
  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { Combobox } from '@tac-ui/web';`} />
      </DocSection>
  ...
  />
        ...
        >
          <div className="flex flex-col gap-1.5 w-full">
            <label htmlFor="country-combobox" className="text-sm font-medium text-[var(--foreground)]">
              Country
            </label>
            <Combobox
              id="country-combobox"
...
/>`}
        >
          <Combobox disabled options={frameworkOptions} placeholder="Select a framework..." />
        </Showcase>
      </DocSection>
        ...
        <PropsTable
          data={[
            ...
            },
            {
              ...
              description:
                pt?.props?.['id'] ??
                'HTML id for the input element, auto-generated if omitted. Use with Label htmlFor for accessibility.',
            },
            {
              name: 'disabled',
              type: 'boolean',
              ...
              description:
                pt?.props?.['disabled'] ??
                'Disables the input, blocking all interaction and showing a not-allowed cursor.',
            },
            {
              name: 'className',
              type: 'string',
              default: '-',
              description: pt?.props?.['className'] ?? 'Additional CSS class names applied to the input element.',
            },
          ]}
        />
      </DocSection>
