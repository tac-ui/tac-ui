  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { EmptyState } from '@tac-ui/web';`} />
      </DocSection>

      <DocSection title="Playground">
        <DocText>Interactively configure the EmptyState props below.</DocText>
        <Playground
          controls={{
            title: {
              type: 'text',
        ...
        <PropsTable
          data={[
            ...
            },
            {
              ...
              description:
                pt?.props?.['icon'] ??
                'Optional icon or illustration displayed above the title inside a blurred circular container.',
            },
            {
              name: 'description',
              type: 'string',
            ...
            },
            {
              ...
              description:
                pt?.props?.['visible'] ??
                'When false, the component animates out using dismissVariants before unmounting via AnimatePresence.',
            },
            {
              name: 'className',
              type: 'string',
