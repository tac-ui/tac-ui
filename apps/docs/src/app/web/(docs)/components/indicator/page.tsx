  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { Indicator } from '@tac-ui/web';`} />
      </DocSection>

      <DocSection title="Playground">
        <DocText>Interactively configure the Indicator props below.</DocText>
        <Playground
          controls={{
            variant: {
              type: 'select',
      ...
      <DocSection title={pt?.sections?.['linear']?.title ?? 'Linear'}>
        ...
        <Showcase className="flex-col items-stretch" code={`<Indicator variant="linear" />`}>
        ...
        <PropsTable
          data={[
            ...
            },
            {
              ...
              description:
                pt?.props?.['size'] ??
                'Diameter in pixels used for the circular variant. Stroke width scales automatically.',
            },
            {
              name: 'color',
              type: 'string',
              ...
              description:
                pt?.props?.['color'] ??
                'CSS color value for the animated portion. Accepts any valid CSS color or token variable.',
            },
            {
              name: 'className',
              type: 'string',
