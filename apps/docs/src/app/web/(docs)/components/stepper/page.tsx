  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { Stepper, Step } from '@tac-ui/web';`} />
      </DocSection>

      <DocSection title="Playground">
        <DocText>Interactively configure the Stepper props below.</DocText>
        <Playground
          controls={{
            currentStep: {
              type: 'select',
        ...
        <PropsTable
          data={[
            ...
            },
            {
              ...
              type: 'string',
              default: '-',
              description: pt?.props?.['description'] ?? 'Optional supporting text displayed below the title.',
            },
            {
              name: 'icon',
              type: 'React.ReactNode',
