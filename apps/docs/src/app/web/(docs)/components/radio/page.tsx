  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { RadioGroup, Radio } from '@tac-ui/web';`} />
      </DocSection>

      <DocSection title="Playground">
        <DocText>Interactively configure the Radio group props below.</DocText>
        <Playground
          controls={{
            disabled: {
              type: 'boolean',
          ...
          <PropsTable
            data={[
              ...
              },
              {
                ...
                type: 'string',
                default: '-',
                description: pt?.props?.['label'] ?? 'Label text displayed next to the radio.',
              },
              {
                name: 'id',
                type: 'string',
                default: '-',
                description: pt?.props?.['id'] ?? 'Unique id for the radio input element.',
              },
              {
                name: 'disabled',
                type: 'boolean',
                default: 'false',
                description: pt?.props?.['disabled'] ?? 'Disables this radio item when true.',
              },
            ]}
          />
        </DocSubSection>
