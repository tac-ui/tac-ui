  ...
  return (
    <DocPage>
      ...
      <DocSection title="Import">
        <PreviewCode code={`import { ColorPicker } from '@tac-ui/web';`} />
      </DocSection>
...
/>`}
      ...
      <DocSection title={pt?.sections?.['swatches-only']?.title ?? 'Swatches Only'}>
        ...
        <Showcase
          code={`<ColorPicker label="Swatches Only" showSpectrum={false} showChannels={false} showEyeDropper={false} />`}
          className="items-start"
        >
      ...
      <DocSection title={pt?.sections?.['without-input']?.title ?? 'Without Input'}>
        ...
        <Showcase
          code={`<ColorPicker label="Quick Pick" showInput={false} showChannels={false} />`}
          className="items-start"
        >
      ...
      <DocSection title={pt?.sections?.['error-state']?.title ?? 'Error State'}>
        ...
        <Showcase
          code={`<ColorPicker label="Theme Color" error errorMessage="Please select a color." />`}
          className="items-start"
        >
        ...
        <PropsTable
          data={[
            ...
            },
            {
              ...
              type: 'boolean',
              default: 'true',
              description: pt?.props?.['showEyeDropper'] ?? 'Shows the eyedropper button (requires browser support).',
            },
            {
              name: 'showChannels',
              type: 'boolean',
              default: 'true',
              description: pt?.props?.['showChannels'] ?? 'Shows RGB/HSB channel inputs for precise values.',
            },
            {
              name: 'error',
              type: 'boolean',
