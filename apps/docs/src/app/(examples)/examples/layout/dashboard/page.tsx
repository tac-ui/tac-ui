...
import { ArrowLeft, LayoutDashboard, ShoppingCart, Users, Settings, TrendingUp, DollarSign, Package, Activity } from '@tac-ui/icon';
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {stats.map((stat) => {
            ...
            return (
              <div key={stat.label} className="p-4 rounded-[var(--radius-m)] border border-solid border-[var(--border)] bg-[var(--card)]">
