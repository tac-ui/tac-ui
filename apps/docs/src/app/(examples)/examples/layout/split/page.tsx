      ...
      left={
        <div className="flex flex-col items-center justify-center h-full gap-6">
          ...
          <div className="text-center max-w-md">
            ...
            <p className="text-base text-[var(--muted-foreground)] m-0 leading-relaxed">Sign in to your account to continue where you left off.</p>
          </div>
        </div>
      }
      right={
        <div className="flex flex-col justify-center h-full px-12 lg:px-16">
          <div className="w-full flex flex-col gap-6">
            <div>
              ...
              <p className="text-base text-[var(--muted-foreground)] m-0">Enter your credentials to access your account</p>
            </div>
            <div className="w-full flex flex-col gap-4">
              ...
              <p className="text-sm text-center text-[var(--muted-foreground)] m-0">
                Don&apos;t have an account? <span className="text-[var(--primary)] cursor-pointer font-medium">Sign up</span>
              </p>
            </div>
          </div>
        </div>
